                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="txt_category_name" value = "<?php echo $category["Name_cate"] ?>">
                                            <p class="help-block">Input name here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Category Description</label>
                                            <textarea class="form-control" rows="3" name="txt_category_description"><?php echo $category["Mota"] ?></textarea>
