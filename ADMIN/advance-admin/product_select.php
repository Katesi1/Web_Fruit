                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                Products
                                <a href="product.php" style="float: right;"> Thêm sản phẩm >> </a>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">   
                                    ...
                                    <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td class="success"style="width:50px"><?php echo $product["product_id"] ?></td>
                                                <td class="info"style="width:100px"><?php echo $product["name"] ?></td>
                                                <td class="warning"style="width:50px"><?php echo $product["number"] ?></td>
                                                <td > <img src="../../UPLOAD/<?php echo $product["Picture"] ?>" style="width:150px"></td>
                                                <td class="danger"style="width:150px"><?php echo $product["category"] ?></td>
                                                <td class="success"style="width:150px"><?php echo $product["date"] ?></td>
                                                <td class="info"style="width:100px"><?php echo $product["price"] ?></td>
                                                <td class="warning" style="width:500px"><?php echo $product["description"] ?></td>
                                                <td class="danger" style="width:150px">
