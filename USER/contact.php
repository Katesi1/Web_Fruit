          ...
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            <form action=""  method="POST" enctype="multipart/form-data">
              <div class="contact_form-container">
                <div>
                  <div>
                    <input type="text" placeholder="Full Name" name="txt_Name"/>
                  </div>
                  <div>
                    <input type="email" placeholder="Email" name="txt_Email" />
                  </div>
                  <div>
                    <input type="text" placeholder="Phone Number" name="txt_Phone"/> 
                  </div>
                  <div>
                    <input type="text" class="message_input" placeholder="Message" name="txt_Message"/>
                  </div>
                  <div>
