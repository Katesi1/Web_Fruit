          ...
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            <form action=""  method="POST" enctype="multipart/form-data">
              <div class="contact_form-container">
                <div>
                  <div>
                    <input type="text" placeholder="Tên đăng nhập" name="txt_Name"/>
                  </div>
                  <div>
                  ...
                  <div>
                      <span>
                          <a href="../ADMIN/advance-admin/login_forgotpss.php" >Quên mật khẩu? </a> 
                    </span>
                  </div>
                  <div>
                    <button type="submit" name="btn_submit"> Đăng Nhập
                    </button>
                  </div><br>
                  <div>
                    <a href="../../web_thuchanh/ADMIN/advance-admin/register.php">Đăng Ký</a>
                  </div>
                </div>
              </div>
            </form>
